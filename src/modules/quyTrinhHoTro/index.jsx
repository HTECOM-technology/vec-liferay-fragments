...
function QuyTrinhHoTroPage() {
    ...
    const MySupportIcon = () => (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.6663 8.00004C14.6663 4.31814 11.6816 1.33337 7.99967 1.33337C4.31778 1.33337 1.33301 4.31814 1.33301 8.00004C1.33301 11.6819 4.31778 14.6667 7.99967 14.6667C11.6816 14.6667 14.6663 11.6819 14.6663 8.00004Z" fill="white" fill-opacity="0.2" />
            ...
            <path d="M14.6663 8.00004C14.6663 4.31814 11.6816 1.33337 7.99967 1.33337C4.31778 1.33337 1.33301 4.31814 1.33301 8.00004C1.33301 11.6819 4.31778 14.6667 7.99967 14.6667C11.6816 14.6667 14.6663 11.6819 14.6663 8.00004Z" stroke="white" stroke-width="1.5" stroke-linejoin="round" />
    ...
    return (
        <PageWrap>
            <PageHeader>
                <span className="header-title">Chọn quy trình để gửi yêu cầu hỗ trợ</span>
                <MyRequestButton onClick={handleMyRequests}>
                    <MySupportIcon />
                    Yêu cầu của tôi
                </MyRequestButton>
            </PageHeader>
            ...
            <ContentWrap>
                ...
                />
                <RequestForm activeItem={activeItem} />
            </ContentWrap>
        </PageWrap>
    );
}
