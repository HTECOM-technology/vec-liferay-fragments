...
const INITIAL_COMMENTS = [
    {
        id: 1,
        author: "Nguyễn Văn A",
        content: "Đã tiếp nhận yêu cầu, đang xem xét và phân công xử lý.",
        createdAt: "09:00 10/04/2026",
    },
];
...
function MyRequestDetail({ record, onBack, onStatusChange }) {
    ...
    const statusCfg = REQUEST_STATUS_CONFIG[record.status] || {};
                ...
                <DetailInfoCard>
                    ...
                    <DetailInfoCardBody>
                        ...
                        <DetailRow>
                            ...
                            <span className="detail-value">{record.subProcess}</span>
                        </DetailRow>
                        <DetailRow>
