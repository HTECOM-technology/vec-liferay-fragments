...
function CreateVoteModal({ visible, onClose, onSubmit, submitting }) {
    ...
    const unitOptions = [
        ...
        { value: "unit1", label: "Đơn vị 1" },
        { value: "unit2", label: "Đơn vị 2" },
    ];

    const departmentOptions = [
        { value: "all", label: "Tất cả phòng ban" },
        { value: "dept1", label: "Phòng Kỹ thuật" },
        { value: "dept2", label: "Phòng Nhân sự" },
    ];

    const memberOptions = [
        { value: "all", label: "Tất cả thành viên" },
        { value: "member1", label: "Nguyễn Văn A" },
        { value: "member2", label: "Trần Thị B" },
    ];
    ...
    return (
        ...
        >
            <ModalHeader>
                ...
                <span className="header-title">Tạo cuộc bình chọn</span>
