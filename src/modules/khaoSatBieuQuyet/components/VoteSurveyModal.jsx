...
function VoteSurveyModal({ visible, survey, onClose, onSubmit, allowMultiple }) {
    // State for selected options
    const [selectedOptions, setSelectedOptions] = useState([]);

    // Reset selection when modal opens with new survey
    useEffect(() => {
        if (visible) {
            setSelectedOptions([]);
        }
    ...
    }, [selectedOptions, survey?.id, allowMultiple, onSubmit]);
                ...
                <OptionsContainer>
                    {survey.options?.map((option) => (
                        ...
                        >
                            ...
                            <RadioButton $selected={isSelected(option.id)} />
                        </OptionItem>
                    ))}
                </OptionsContainer>

                <SubmitButton onClick={handleSubmit} disabled={!hasSelection}>
                    Bình chọn
                </SubmitButton>
            </ModalBody>
        </Modal>
