...
public class JournalManagementToolbarDisplayContext
	...
	public List<LabelItem> getFilterLabelItems() {
		...
		labelItemListWrapper.add(
			...
			_journalDisplayContext::isCreateDateRangeFilterEnabled,
			labelItem -> {
				labelItem.putData(
					"removeLabelURL",
					PortletURLBuilder.create(
					...
					LanguageUtil.get(httpServletRequest, "create-date") +
						": " +
							_journalDisplayContext.
								getCreateDateRangeStartDateString() +
									" - " +
										_journalDisplayContext.
											getCreateDateRangeEndDateString());
			}
		);
	...
	public String getSearchActionURL() {
		return PortletURLBuilder.createRenderURL(
			...
			"endDate",
			() -> {
				if (_journalDisplayContext.isCreateDateRangeFilterEnabled()) {
					return _journalDisplayContext.
						getCreateDateRangeEndDateString();
				}
